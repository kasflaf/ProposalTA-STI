...
\begin{center}
    ...
    % \vspace*{2cm} agak aneh ini ???

    {\Large\bfseries
      Perancangan dan Implementasi \textit{Backend}\\
      \textit{Real-Time Runner Tracking} dan \textit{ETA Prediction}\\
      dengan Skalabilitas dan \textit{High Availability}\\
      untuk ITB Marathon\\
    }
...
\begin{center}
  ...
  {\large\bf Program Studi Sistem dan Teknologi Informasi}\\
  {\large Sekolah Teknik Elektro dan Informatika}\\
  {\large Institut Teknologi Bandung}\\
...
% ==========================================
	Pembimbing,  \\[3cm]
  \underline{Dr. Riza Satria Perdana, S.T, M.T.}   \\[0.2cm]
