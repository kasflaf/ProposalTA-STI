...
\begin{enumerate}
    ...
    Hal-hal seperti manajemen tim, deteksi pergantian pelari untuk kategori relay, pengelolaan pelanggaran dan penalti, pencatatan kehadiran, perkiraan jadwal penjemputan, \textit{drop bag}, serta pemants masih dilakukan secara manual dan rentan terhadap kesalahan.
\end{enumerate}
...
\input{table/kebutuhan-fungsional.tex}
...
\input{table/kebutuhan-nonfungsional.tex}
