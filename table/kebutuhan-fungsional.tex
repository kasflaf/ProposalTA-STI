...
Backend menyediakan API untuk pembuatan rute lomba (polyline), pengaturan checkpoint dan water station, serta pendefinisian jam buka, jam tutup, dan cutoff time untuk setiap titik. \\
\hline
...
\hline
FR-09 & API Informasi Logistik & 
Backend menyediakan API untuk menampilkan informasi penjemputan, layanan medis, serta drop bag dari panitia kepada peserta. \\
\hline
FR-10 & API Permintaan Bantuan & 
...
\hline
FR-11 & Manajemen Pengguna dan RBAC & 
...
\hline
FR-12 & Sistem Notifikasi Event-driven & 
Backend menyediakan mekanisme pengiriman notifikasi berdasarkan event penting seperti nearing cutoff time, status darurat, dan perubahan status peserta. \\
\hline
FR-13 & Penyimpanan Riwayat dan Audit Log & 
...
\hline
FR-14 & API Dashboard Operasional & 
Backend menyediakan API data agregat untuk dashboard panitia termasuk deteksi pelari mendekati cutoff, statistik checkpoint, dan data operasional lainnya. \\
\hline
FR-15 & API Verifikasi Registrasi & 
Backend menyediakan endpoint untuk validasi pembayaran atau kelengkapan administrasi peserta sebelum dinyatakan resmi terdaftar. \\
\hline
FR-16 & Sinkronisasi dan Buffering Offline & 
